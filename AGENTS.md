# AGENTS.md — Hinweise für KI-Agenten (gregMod.HexViewer)

Repo: [https://github.com/mleem97/gregMod.HexViewer](https://github.com/mleem97/gregMod.HexViewer) · Lizenz: Apache-2.0 · Version: siehe `VERSION`.
